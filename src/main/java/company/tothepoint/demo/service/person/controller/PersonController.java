...
public class PersonController {
    ...
    public Person getPerson(@PathVariable("id") Long id) {
        return personRepository.findById(id).orElseThrow(()->new RuntimeException("Missing Object"));
    }
    ...
    public void updatePerson(@PathVariable("id") Long id, @RequestBody Person person) {
        Person existingPerson = personRepository.findById(id).orElseThrow(()->new RuntimeException("Missing Object"));
